      ...
      <section className="client-page__sections">
          ...
          <div className="client-card">
            ...
            <div className="client-card__content">
              ...
              <ul className="client-list">
                <li>Responsive customer support via email (mail.fitcoach@gmail.com)</li>
          ...
          <div className="client-card">
            ...
            <div className="client-card__content">
              ...
              <ul className="client-list">
                <li><strong>General Inquiries:</strong> mail.fitcoach@gmail.com</li>
                <li><strong>Technical Support:</strong> mail.fitcoach@gmail.com (Subject: "Technical Support")</li>
                <li><strong>Coach Partnerships:</strong> mail.fitcoach@gmail.com (Subject: "Coach Partnership")</li>
                <li><strong>Business Inquiries:</strong> mail.fitcoach@gmail.com (Subject: "Business Inquiry")</li>
                <li><strong>Media & Press:</strong> mail.fitcoach@gmail.com (Subject: "Media Inquiry")</li>
              </ul>
