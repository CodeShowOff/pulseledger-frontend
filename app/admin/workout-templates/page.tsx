// app/admin/workout-templates/page.tsx
"use client";
  ...
  return (
    <div>
      <section className="admin-page-header">
        <div>
          <h1 className="admin-page-header__title">Workout Templates</h1>
        ...
        <div className="admin-page-header__actions">
          <Link
            href="/admin/workout-templates/create"
                      ...
                      <td>
                        <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
                          <button
                            ...
                            onClick={() => router.push(`/admin/workout-templates/${t._id}/edit`)}
                            title="Edit"
                          >
