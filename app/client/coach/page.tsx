...
export default function ClientCoachProfilePage() {
  ...
  const hasDualContactActions = Boolean(data?.whatsappNumber && coachCode);
        ...
        <Card className="border-slate-200/80 bg-white/95">
          <CardContent className="space-y-5 p-5 pt-6 sm:p-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              {data.whatsappNumber || coachCode ? (
                <div
                  className={cn(
                    "items-center gap-2 sm:justify-end",
                    hasDualContactActions ? "grid w-full grid-cols-2 sm:w-[320px]" : "flex flex-wrap"
                  )}
                >
                  {data.whatsappNumber ? (
                    <button
                      type="button"
                      className={cn(whatsappActionClass, hasDualContactActions && "w-full justify-center")}
                  ...
                  {coachCode ? (
                    <span
                      className={cn(
                        "inline-flex h-8 items-center gap-1.5 rounded-xl border border-slate-200 bg-slate-50 px-3 text-xs font-semibold uppercase tracking-wide text-slate-700",
                        hasDualContactActions && "w-full justify-center"
                      )}
                    >
