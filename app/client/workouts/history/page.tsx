    ...
    <div className="client-page__sections space-y-4 pb-6">
      <header className="space-y-2">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-[11px] font-medium text-indigo-600">Progress timeline</p>
        </div>
      </header>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="mt-3 flex flex-nowrap items-center justify-between gap-1 whitespace-nowrap text-[10px] leading-none text-slate-500 sm:text-[11px]">
          {["completed", "partial", "missed", "rest_day", "scheduled"].map((status) => (
                  ...
                  >
                    ...
                    {selectedLog.clientNotes ? (
                      <p className="mt-3 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
                        <span className="font-semibold">Notes:</span> {selectedLog.clientNotes}
                      </p>
                    ) : null}
                  </article>
                ))}
