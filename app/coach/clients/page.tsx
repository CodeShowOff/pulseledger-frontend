        ...
        <Card className="overflow-hidden border-indigo-100/70 bg-gradient-to-br from-indigo-600 via-blue-600 to-violet-600 text-white shadow-[0_14px_30px_-25px_rgba(79,70,229,0.55)]">
          <CardHeader className="gap-2 p-4 sm:p-6">
            <div className="flex items-start justify-between gap-3">
              ...
              <Link href="/coach/received-requests" className="shrink-0">
                <Button
                  variant="outline"
                  className="h-9 justify-center gap-1.5 whitespace-nowrap border-white/25 bg-white/10 px-3 text-xs font-semibold text-white hover:bg-white/20 hover:text-white sm:h-10 sm:px-3.5 sm:text-sm"
                >
